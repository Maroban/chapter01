...
public class Ex08 {
	...
	public static void main(String[] args) {
		...
		System.out.println(++a);
		System.out.println(a); //a의 값은 변했을까??
		
		System.out.println(b); //b --> 2
		System.out.println(--b);
		System.out.println(b); //b의 값은 변했을??
		...
		System.out.println(num++);	//num 출력, 6 --> 7
		System.out.println(num++ *10);	//num*10 출력, num 7 --> 8
